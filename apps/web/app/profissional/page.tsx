...
import { getMyBookings, getMyInvoices, type Booking, type Invoice } from "../../lib/bcos-api";
...
export default async function ProfessionalPage() {
  ...
  try { [bookings, invoices] = await Promise.all([getMyBookings(), getMyInvoices()]); } catch (caught) { console.error("BCOS professional portal load failed:", caught); error = "Não foi possível carregar seu portal neste momento."; }
